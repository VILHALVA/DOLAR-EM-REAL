...
## DESCRIÇÃO:
O aplicativo "Conversor de Dólar para Real" permite que os usuários convertam valores em dólares americanos (USD) para reais brasileiros (BRL). A conversão é feita com base na taxa de câmbio fixa de 1 USD = 5.19 BRL. O aplicativo fornece uma interface simples e direta para realizar essa conversão.

## FUNCIONALIDADES:
1. **Entrada de Valor em Dólares:**
   - O usuário pode inserir o valor em dólares americanos através de um campo de texto numérico.

2. **Conversão de Valor:**
   - Ao pressionar o botão "CONVERTER", o aplicativo calcula o valor equivalente em reais brasileiros multiplicando o valor inserido pela taxa de câmbio (5.19).

3. **Exibição do Resultado:**
   - O resultado da conversão é exibido em um campo de texto abaixo do botão de conversão, informando o valor em reais brasileiros.
